        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 leading-relaxed">
              Курс для женщин, стремящихся к развитию внутренней гармонии, элегантности и истинной женственности
            </p>
            <Button 
              size="lg" 
          ...
          <div className="max-w-5xl mx-auto">
              ...
              {[
                {
                  icon: 'Heart',
                  title: 'Женственность',
                  description: 'Раскройте свою природную грацию и мягкость через практики осознанности и самопринятия'
                },
                {
                  icon: 'Sparkles',
                  title: 'Элегантность',
                  description: 'Развите внутреннюю и внешнюю красоту, научитесь держаться с достоинством королевы'
                },
                {
                  icon: 'Flower2',
                  title: 'Гармония',
                  description: 'Обретите баланс между внутренним миром и внешним проявлением, найдите свою силу'
                }
              ].map((item, idx) => (
                <Card 
                  key={idx} 
            ...
            <div className="mt-16 bg-gradient-to-r from-accent/30 to-secondary/30 rounded-3xl p-8 md:p-12">
              ...
              <ul className="space-y-4">
                {[
                  'Глубокое понимание своей женской природы',
                  'Практики для развития грации и элегантности',
                  'Инструменты для обретения внутренней гармонии',
                  'Поддержку сообщества единомышленниц',
                  'Личные трансформации под руководством эксперта'
                ].map((item, idx) => (
